...
public sealed class SnapDeciderTests
{
    ...
    {
        return new SnapDecider(new MonitorLookupWindowInspector(monitors));
    }
    ...
    private sealed class MonitorLookupWindowInspector(params MonitorInfo[] monitors) : IWindowInspector
    {
